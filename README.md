...
> Classical OpenCV document scanner (edge detection, perspective correction, adaptive thresholding) feeding PaddleOCR for structured text extraction — no deep learning in the vision pipeline.
